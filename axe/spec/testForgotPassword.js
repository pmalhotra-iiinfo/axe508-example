...
describe('ODDS demo', function() {
    ...
    beforeEach(function(done) {
        ...
        driver.get('http://calories-tracker-oddsprep.b9ad.pro-us-east-1.openshiftapps.com/resources/public/forgot-password.html')
            .then(function () {
                done();
            });
    });
    ...
    it('should analyze the Forgot Password Page', function (done) {
		// driver.findElement(selenium.By.name("signon"))
         //    .then(function () {
			    ...
			    var stream = fs.createWriteStream("reports/testForgotPassword.html");
