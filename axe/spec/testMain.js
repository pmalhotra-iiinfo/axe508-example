...
describe('ODDS demo', function() {
    ...
    beforeEach(function(done) {
        ...
        driver.get('http://calories-tracker-oddsprep.b9ad.pro-us-east-1.openshiftapps.com/resources/public/login.html')
            .then(function () {
                done();
            });
    });
    ...
    it('should analyze the Main Page', function (done) {

    	username = driver.findElement(selenium.By.name("username"));
    	username.sendKeys("test123");

    	password = driver.findElement(selenium.By.name("password"));
    	password.sendKeys("Password2");

    	driver.findElement(selenium.By.id("login")).click();
		...
		// driver.findElement(selenium.By.name("signon"))
         //    .then(function () {
			    ...
			    var stream = fs.createWriteStream("reports/testMain.html");
